...
class Model(nn.Module):
    def __init__(self, units, stack_cnt, time_step, multi_layer, horizon=1, dropout_rate=0.5, leaky_rate=0.2,
                 device='cpu',flight_t='',flight_loader=''):
        ...
        self.flight_t = flight_t
        self.GRU2 = nn.GRU(self.unit, self.unit) ##
    ...
    def self_graph_attention(self, input):
        ...
        data = torch.mul(query.repeat(1, 1, N).view(bat, N * N, 1), key.repeat(1, N, 1))
        data = data.squeeze(2)
